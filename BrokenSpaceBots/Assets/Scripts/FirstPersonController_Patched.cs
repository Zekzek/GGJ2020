...
namespace Bots.FirstPerson
{
    /// <summary>
    /// "Borrowed" from Unity's standard FirstPersonController, but improved using tips from the following blog:
    /// http://nothkedev.blogspot.com/2017/11/how-to-cope-with-standard-unity-fps.html
    /// 
    /// </summary>
    [RequireComponent(typeof(CharacterController))]
    [RequireComponent(typeof(AudioSource))]
    public class FirstPersonController_Patched : MonoBehaviour
    {
